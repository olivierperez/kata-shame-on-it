...
class Person(
    ...
    /**
     * Secondary constructor with firstname, lastname and age of the [fr.o80.kata.snippet6.Person].
     */
    constructor(firstname: String, lastname: String, age: Int) : this("$firstname $lastname", age, null)

    /**
     * Secondary constructor to clone the [fr.o80.kata.snippet6.Person].
     */
    constructor(origin: Person) : this(origin.fullname, origin.size)

    /**
     * Set the info of the [fr.o80.kata.snippet6.Person].
     *
     * @param age The age of the [fr.o80.kata.snippet6.Person]
